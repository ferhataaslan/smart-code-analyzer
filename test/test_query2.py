...
(parameter_declaration declarator: (reference_declarator declarator: (identifier) @var_decl))
...
(declaration declarator: (init_declarator declarator: (reference_declarator declarator: (identifier) @var_decl)))
